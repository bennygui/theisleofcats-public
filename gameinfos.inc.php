...
$gameinfos = [
    ...
    'publisher_website' => 'https://thecityofkings.com/',
    ...
    'tie_breaker_description' => totranslate("In the normal game mode, the number of fish remaining when the game ends. In the family game mode, the number of filled rooms."),
    ...
    'player_colors' => ['67bed0', '29b35a', 'd45965', '9866ab'],
    ...
    'presentation' => array(
        totranslate("The Isle of Cats is a competitive, medium-weight, card-drafting, polyomino cat-placement board game."),
        totranslate("In the game, you are citizens of Squalls End on a rescue mission to The Isle of Cats and must rescue as many cats as possible before the evil Lord Vesh arrives. Each cat is represented by a unique tile and belongs to a family, you must find a way to make them all fit on your boat while keeping families together."),
    ),
